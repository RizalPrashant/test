 ...
 * using an instance of the IUSingleLinkedList or WrappedList classes. 
 * @author CS221 
 */
public class Sort_TestCase
{
	...
	public static final long MAX_TIME = 50;   // in milliseconds (0.05 second)
	// seed value for random array 
	public static final int SEED_VALUE = 123; 
	...
	/**
	 * Tests sort method
	 * @param list - implementation of IUListWithListIterator interface
	 * @param sortedList - implementation of IUListWithListIterator interface
	 */
	public static void sort(IUListWithListIterator<Integer> list, IUListWithListIterator<Integer> sortedList) 
	{
		Sort.sort(list);
	 ...
	 */
	public static void sort(IUListWithListIterator<Integer> list, IUListWithListIterator<Integer> sortedList, Comparator<Integer> c) 
	{
		Sort.sort(list, c);
		Assert.assertTrue(equal(list, sortedList));
	}
	 ...
	 */
	public static void sort(IUListWithListIterator<Integer> list) 
	{
	 ...
	 * @param time - long value 
	 */
	public static void sort(IUListWithListIterator<Integer> list, Comparator<Integer> c) 
	{
		long startTime = System.currentTimeMillis(); 
		Sort.sort(list, c);
		long stopTime = System.currentTimeMillis(); 
	 ...
	 * @param list1 - implementation of IUListWithListIterator interface
	 * @param list2 - implementation of IUListWithListIterator interface
	 * @return same - true if lists contain same objects in same order, false otherwise
	 */
	private static boolean equal(IUListWithListIterator<Integer> list1, IUListWithListIterator<Integer> list2)
	{
		boolean same =true;
	...
	/**
	 * Converts array of Integers to IUListWithListIterator list with same elements 
	 * @param elements - array of Integers 
	 * @return list - IUListWithListIterator implementation  
	 */
	public static IUListWithListIterator<Integer> newList(Integer[] elements, ListType type) 
	{
		IUListWithListIterator<Integer> list = null;
	...
	/**
	 * Creates a IUListWithListIterator list of given size with random Integers. 
	 * @param size - int value  
	 * @return list - IUListWithListIterator implementation  
	 */
	public static IUListWithListIterator<Integer> newList(int size, ListType type) 
	{
		IUListWithListIterator<Integer> list = null;
